 ...
 * Caleb Pitan for short or say it's wha'I  prefer
 * Copyright 2018 RealLongman
 *
 * see: https://webpaddy.blogspot.com
 * Dependencies : jQuery;
 *
	...
	(function(){
		...
		function checkRequirements() {
			...
			if(!jQueryNotInstalled() && !iLogged)
				displayStr("jQuery found!"), iLogged = true;
		}
 	...
 	Navigation.fn = Navigation.prototype = {
		...
		listen: {
 		...
 		init: function(_element, options) {
			...
			var destinationId = element.attr("data-target"),
		...
		drawer: function(destination, direction, time) {
			...
			function touchStarted(e) {
				...
				startX = e.changedTouches[0].pageX || e.changedTouches[0].clientX;
			...
			function touchMoves(e) {
				...
				resumeX = e.changedTouches[0].pageX || e.changedTouches[0].clientX;
